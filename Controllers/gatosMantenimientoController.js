...
export const postGastosMantenimiento = async (req, res) => {
  ...
  try {
    ...
    const newGastosMantenimiento = await GastosMantenimiento.create({
      ...
      proveedor: gastosMantenimiento.proveedor,
...
export const putGastosMantenimiento = async (req, res) => {
  ...
  try {
    ...
    await findGastosMantenimiento.update(gastoMantenimiento);
